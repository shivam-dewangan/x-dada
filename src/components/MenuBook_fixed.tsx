...
const MenuBook = () => {
  ...
  // Hide swipe hint after 5 seconds on first load
  useEffect(() => {
    if (page === 0) {
  ...
  return (
    <div className="h-dvh w-dvw bg-background flex flex-col overflow-hidden no-scrollbar relative">  
      {/* Book area */}
      ...
      {/* Swipe hint */}
      {page === 0 && !isFlipping && showSwipeHint && (
        <motion.div
